...
import { CODE_ARROW_DOWN, CODE_ARROW_LEFT, CODE_ARROW_RIGHT, CODE_ARROW_UP } from 'constants/keys';
...
export const clueRange = (clue, direction, width) => {
  ...
  return clue ? _.range(clue.clueStart, clue.clueEnd + stepSize, stepSize): [];
};
...
export const cellNumberInClue = (cellNumber, clue, direction, width) => {
  const inRange = clue ? cellNumber <= clue.clueEnd && cellNumber >= clue.clueStart: false;
  if (direction === across) {
    return inRange;
  }
